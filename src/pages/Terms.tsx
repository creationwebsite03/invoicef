      ...
      <div className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-outline-variant/10 space-y-8">
        ...
        <section>
          ...
          <p className="text-zinc-600 leading-relaxed">
            By accessing and using INVOXA to generate financial documents, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-zinc-600 leading-relaxed">
            INVOXA provides professional financial utility tools. The documents generated are meant for professional and legal billing. However, INVOXA is not a substitute for certified accounting or legal advice. You are solely responsible for ensuring the mathematical and legal accuracy of your generated documents based on your local jurisdiction.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-zinc-600 leading-relaxed">
            The service and its original content, features, completely distinct brand imagery, and functionality are and will remain the exclusive property of INVOXA and its licensors.
          </p>
        </section>
      </div>
    </div>
